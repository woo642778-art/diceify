type IconName = "home" | "deck" | "tree" | "analysis" | "more" | "search" | "user";
...
export function UiIcon({ name, size = 18 }: { name: IconName; size?: number }) {
  ...
  if (name === "analysis")
    return <svg {...common}><path d="M4 18.5V14M10 18.5V9M16 18.5V5.5M21 18.5H3"/><circle cx="16" cy="5.5" r="1.5"/></svg>;
  if (name === "search")
