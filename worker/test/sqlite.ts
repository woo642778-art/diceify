...
export function testDatabase() {
  ...
  for(const file of ["0001_platform.sql","0002_phase2_integrity.sql","0003_operations.sql","0004_guild_directory.sql"]) sqlite.exec(readFileSync(new URL(`../migrations/${file}`,import.meta.url),"utf8"));
  class Statement {
